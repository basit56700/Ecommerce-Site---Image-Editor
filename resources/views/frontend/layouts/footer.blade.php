            ...
            <div class="row" bis_skin_checked="1">
                <div class="col-xs-12 col-sm-6 col-md-3 mt-paddingbottomsm" bis_skin_checked="1">
                    ...
                    <div class="f-widget-about" bis_skin_checked="1">
                        ...
                        <p>Exercitation ullamco laboris nisi ut aliquip ex commodo consequat. Duis aute irure dolor in
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 text-right" bis_skin_checked="1">
                    ...
                    <div class="f-widget-about" bis_skin_checked="1">
                        ...
                        <ul class="list-unstyled address-list align-right">
                            ...
                            <li><i class="fa fa-phone"></i><a href="tel:15553332211" bis_skin_checked="1">+1 (555) 333
                                    22 11</a></li>
                            <li><i class="fa fa-envelope-o"></i><a href="mailto:info@schon.chair"
                                    bis_skin_checked="1">info@schon.chair</a></li>
                        </ul>
                    </div>
                    <!-- F Widget About of the Page end -->
                </div>
    ...
    <div class="footer-area" bis_skin_checked="1">
        <div class="container" bis_skin_checked="1">
            <div class="row" bis_skin_checked="1">
                ...
                <div class="col-xs-12 col-sm-6 text-right" bis_skin_checked="1">
                    <div class="bank-card" bis_skin_checked="1">
