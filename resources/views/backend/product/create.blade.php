        ...
        <div class="card-body">
            <form method="post" action="{{ route('product.store') }}">
              ...
              @endforeach --}}
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-btn">
                            <a  data-input="thumbnail-product" data-preview="holder-product" class="btn btn-primary lfm">
                                <i class="fa fa-picture-o"></i> Choose
                            </a>
                        </span>
                        <input id="thumbnail-product" class="form-control" type="text" name="photo"
                            value="{{ old('photo') }}">
                    </div>
                ...
                <div class="form-group">
                  <label for="inputPhoto" class="col-form-label">Photo Room <span class="text-danger">*</span></label>
                  <div class="input-group">
                      <span class="input-group-btn">
                          <a  data-input="thumbnail-room" data-preview="holder-room" class="btn btn-primary lfm">
                              <i class="fa fa-picture-o"></i> Choose
                          </a>
                      </span>
                      <input id="thumbnail-room" class="form-control" type="text" name="room_photo"
                          value="{{ old('room_photo') }}">
                  </div>
